      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-yellow-500/20 p-8 rounded-xl hover:bg-slate-700/50 transition-all" onClick={() => router.push('/online')}>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-yellow-500/20 p-8 rounded-xl hover:bg-slate-700/50 transition-all" onClick={() => router.push('/play/computer')}>
              <div className="flex items-center space-x-4 mb-4">
                <div className="bg-yellow-500 p-3 rounded-lg">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-yellow-500/20 p-8 rounded-xl hover:bg-slate-700/50 transition-all" onClick={() => router.push('/play/pass')}>
              <div className="flex items-center space-x-4 mb-4">
                <div className="bg-yellow-500 p-3 rounded-lg">
